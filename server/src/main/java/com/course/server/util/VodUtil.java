...
public class VodUtil {
    ...
    public static CreateUploadVideoResponse createUploadVideo(DefaultAcsClient vodClient, String fileName) throws ClientException {
        ...
        request.setCateId(1000168204L);
        request.setTemplateGroupId("0e11abff86523c3a994c4f317afb6b97");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI4G56SfiH4Wf7sKyKQJEU";
        //您的AccessKeySecret
        String accessKeySecret = "5VWNPIsce5srCkzQz3xqtzFoMTbL3x";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "E:\\file\\imooc\\course\\course\\s3BwfJ6t.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
